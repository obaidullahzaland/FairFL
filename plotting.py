...
def generate_plots(df, output_dir):
    metrics = ['acc', 'loss', 'time', 'jfi']
    titles = ['Accuracy over Rounds', 'Log Loss over Rounds', 'Time over Rounds', 'JFI over Rounds']
    ylabels = ['Accuracy (%)', 'Log Loss', 'Time (s)', 'JFI']
    ...
    for mode in modes:
        ...
        for distribution in distributions:
            ...
            for clients in clients_list:
                ...
                # Shared legend in original position
